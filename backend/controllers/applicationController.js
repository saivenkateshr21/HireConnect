...
export const postApplication = catchAsyncErrors(async (req, res, next) => {
  ...
  try {
    ...
    const { name, email, coverLetter, phone, address, experienceYears, experienceMonths, jobId } = req.body;
    const applicantID = {
      user: req.user._id,
      role: "Job Seeker",
    };
    ...
    if (
      ...
      return next(new ErrorHandler("Please fill all fields including your experience details.", 400));
    }
